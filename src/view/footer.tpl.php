    ...
    <footer>
      ...
      <div class="footer-infos">
        ...
        <ul class="footer-list" id="footer-right">
          ...
          <li class="footer-element"><a href="<?= $absoluteUrl ?>/cgv-et-mentions-legales">mentions légales</a></li>
          <li class="footer-element"><a href="<?= $absoluteUrl ?>/cgv-et-mentions-legales">CGV</a></li>
        </ul>
      </div>
    </footer>
