<section class="contact">
  <div class="contact-top">
    <img src="<?= $absoluteUrl ?>/img/nav/icon-contact.jpg" alt="Image de contact" class="contact-icon">
  ...
  <div class="contact-zone">
    ...
    <h3>Marseille </h3>
    <p>du 1<sup>er</sup> au 12<sup>e</sup> arrondissement</p>
    <img src="<?= $absoluteUrl ?>/img/map-delivery-v02.svg" alt="Image de Marseille avec les quartiers de livraison" class="contact-zone--image">
  </div>
</section>